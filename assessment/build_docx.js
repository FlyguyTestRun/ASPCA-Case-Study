  ...
  sections: [
    {
      ...
      children: [
        ...
        bulletPoint("**36 Architecture Decision Records**, one per correction, and an operational decision log the running system writes for itself (approvals, adoptions, sign-offs, archives), each with a named approver."),
