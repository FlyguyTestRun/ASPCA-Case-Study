...
| Tests | None | **127**, re-run with the planted traps by [CI](.github/workflows/ci.yml) on every change |
...
| [Decision records](docs/adr/) | 32 ADRs: one per correction, each with the problem, the decision, and the forward impact |
