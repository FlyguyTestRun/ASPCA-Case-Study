...
| Tests | None | **134**, re-run with the planted traps by [CI](.github/workflows/ci.yml) on every change |
...
| [Decision records](docs/adr/) | 34 ADRs: one per correction, each with the problem, the decision, and the forward impact |
