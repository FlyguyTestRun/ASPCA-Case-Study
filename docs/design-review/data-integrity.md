...
**Verdict: valid.** Worth stating plainly: when I reviewed the table by hand I caught three of the four mislabeled tiers. The validator caught all four on its first run. Computed verification beats careful reading, every time, and that gap is the whole argument.
